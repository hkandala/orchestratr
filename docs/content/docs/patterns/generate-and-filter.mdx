...
every provider in the roster must be built into orcr and have its Herdr adapter installed, or the run fails fast with `integration_missing`. see [providers & integrations](/docs/concepts/providers).
