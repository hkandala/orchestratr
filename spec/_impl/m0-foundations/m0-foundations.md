...
- Sections: defaults, herdr, concurrency, timings (all duration knobs in one
  place), logs. Validation with precise errors: unknown keys warn and are ignored
  (suggest nearest valid name — forward/backward compatible),
